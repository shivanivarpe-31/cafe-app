            ...
            <div className="docs-container">
              ...
              <div className="docs-grid">
                ...
                <div className="doc-card">
                  ...
                  <div className="doc-description">
                    5-phase production deployment roadmap with validation steps
                  </div>
                  <a href="#" className="doc-link">
                    View Roadmap →
                  </a>
              ...
              <div className="faq-section">
                ...
                <div className="faq-item">
                  ...
                  <div className="faq-answer">
                    ...
                    <code>ngrok http 5001</code>. Then register the ngrok URL in
                    platform dashboards for testing.
                  </div>
                </div>
                ...
                <div className="faq-item">
                  ...
                  <div className="faq-answer">
                    Use the "Item Mappings" tab to create mappings. You can add
                    items individually or bulk import for efficiency.
                  </div>
                </div>
                ...
                <div className="faq-item">
                  ...
                  <div className="faq-answer">
                    ...
                    name-based matching. Ensure your menu item names are similar
                    to platform item names.
                  </div>
                </div>
              </div>
            </div>
